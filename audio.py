...
if __name__ == '__main__':
    ...
    cnt = 0
    #for spec in specsFromFile('/media/labhdd/ASAS/audio/acafly/XC100185.mp3',
    for spec in specsFromFile('/media/labhdd/ASAS/val/val/audio/LIFECLEF2017_BIRD_SOUNDSCAPE_WAV_RN49849.wav',
                              rate=44100,
                              seconds=1,
                              overlap=0,
                              minlen=1,

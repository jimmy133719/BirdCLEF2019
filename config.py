...
TRAINSET_PATH = '/media/labhdd/ASAS/'
#TRAINSET_PATH = 'datasets/TrainingSet/'
DATASET_PATH = '/media/labhdd/ASAS/train/spec_v4'
DATASET_SPECIAL_PATH = '/media/labhdd/ASAS/train/spec_special_v2'
NOISE_PATH = '/media/labhdd/ASAS/train/noise_v4'
NOISE_SPECIAL_PATH = '/media/labhdd/ASAS/train/noise_special_v2'
...
TESTSET_PATH = '/media/labhdd/ASAS/val/val/audio'
#TESTSET_PATH = '/media/labhdd/ASAS/test/audio/'
